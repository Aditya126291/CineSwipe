...
| Issue | Status |
| --- | --- |
| `action: "explode"` accepted | **Fixed** |
| Re-like after undo not stored | **Fixed** — upsert in `addSwipe` |
| Match by like count only | Client fixed via `isRoomMatch` |

## Verification

- Run [`tests/qa_e2e.js`](../../../../tests/qa_e2e.js) with dev server
- Fourth guest should get 403 or error before lobby

## After successful execution

Update sync action documentation in `Architecture.md`.
